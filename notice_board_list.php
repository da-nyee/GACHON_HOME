...
?>
      	...
      	<div class="form-group">
	    		<div align="right">
      				<button type="button" class="btn btn-primary" onclick="location.href='notice_board_form.php'">글쓰기</button>
	    		</div>
	  	</div>
<?php 
	} else{
...
?>
		<li class="page-item">
          	<a class="page-link" href="notice_board_list.php?page=<?=$new_page?>" aria-label="Previous">
...
?>
			<li class="page-item">
				<a class="page-link" href="notice_board_list.php?page=<?=$i?>"><?=$i?></a>
			</li>
<?php
		}
	}
...
?>
		<li class="page-item">
          	<a class="page-link" href="notice_board_list.php?page=<?=$new_page?>" aria-label="Next">
