	...
	<head>
		...
		<script>
			function check_input(){
				...
				$("#notice_board_modify_form").submit();
			}
		</script>
	</head>
		...
		<div class="container">
		  	<div class="card border-0 shadow my-5">
		    	<div class="card-body p-5">
		      		<form class="form-horizontal" id="notice_board_modify_form" method="post" action="notice_board_modify.php?num=<?=$num?>&page=<?=$page?>" enctype="multipart/form-data">
